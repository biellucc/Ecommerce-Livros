        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control  @error('cep') is-invalid @enderror"
                        id="cep" name="cep" placeholder=" 13025-085">
                    @error('cep')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control  @error('state') is-invalid @enderror"
                        id="state" name="state" placeholder="São Paulo">
                    @error('state')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control  @error('city') is-invalid @enderror"
                        id="city" name="city" placeholder="Campinas">
                    @error('city')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control  @error('n_house') is-invalid @enderror"
                        id="n_house" name="n_house" placeholder="12">
                    @error('n_house')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
